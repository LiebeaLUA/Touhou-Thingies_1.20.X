...
public class DollEnemyAnimation {
        ...
        public static final AnimationDefinition shake = AnimationDefinition.Builder.withLength(1.0F).looping()
                ...
                .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, -8.0F, 3.0F), AnimationChannel.Interpolations.LINEAR)
                ))
                .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        ...
                        new Keyframe(0.4167F, KeyframeAnimations.degreeVec(17.5F, 0.0F, 7.5F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(0.4583F, KeyframeAnimations.degreeVec(17.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                        new Keyframe(0.5F, KeyframeAnimations.degreeVec(17.5F, 0.0F, 7.5F), AnimationChannel.Interpolations.LINEAR),
                        ...
                        new Keyframe(0.9583F, KeyframeAnimations.degreeVec(17.5F, 0.0F, 7.5F), AnimationChannel.Interpolations.LINEAR),
